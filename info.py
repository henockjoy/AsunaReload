...
# Keep-Alive URL
KEEP_ALIVE_URL = environ.get("KEEP_ALIVE_URL", "https://evident-venita-ftx-16bbfdea.koyeb.app/")  # <-- Add this line
#hyper link
...
FILE_AUTO_DELETE_SECONDS = int(environ.get('FILE_AUTO_DELETE_SECONDS', 1800))  # Default: 1 hour
